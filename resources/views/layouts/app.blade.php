                                    ...
                                    class="relative" style="position: relative; z-index: 1300;">
                                        ...
                                        <div x-show="open" 
                                             ...
                                             :style="(window.innerWidth < 640)
                                                                ? 'display:block; position: fixed; left: 0.75rem; right: 0.75rem; top: 4.25rem; bottom: 0.75rem; width: auto; max-width: none; height: auto; max-height: none; margin-top: 0; background-color: #ffffff; border: 1px solid #e5e7eb; border-radius: 0.75rem; box-shadow: 0 10px 25px rgba(15, 23, 42, 0.15); overflow: hidden; z-index: 1400; pointer-events:auto;'
                                                                : 'display:block; position: absolute; right: 0; top: 100%; width: 22rem; max-width: 22rem; height:min(60vh, 28rem); max-height:min(60vh, 28rem); margin-top: 0.5rem; background-color: #ffffff; border: 1px solid #e5e7eb; border-radius: 0.5rem; box-shadow: 0 10px 25px rgba(15, 23, 42, 0.15); overflow: hidden; z-index: 1400;'">
                                                            <div class="p-3 sm:p-4 border-b border-gray-200 flex items-center justify-between gap-2" style="padding: 0 1rem; height: 3.5rem; border-bottom: 1px solid #e5e7eb; background-color: #ffffff; position: absolute; top: 0; left: 0; right: 0; z-index: 2; display: flex; align-items: center; justify-content: space-between; gap: 0.5rem;">
                                            ...
                                            <div class="overflow-y-auto overscroll-contain" :style="(window.innerWidth < 640)
                                                ? 'position:absolute; left:0; right:0; top:3.5rem; bottom:calc(3.25rem + env(safe-area-inset-bottom)); overflow-y:auto; overflow-x:hidden; overscroll-behavior:contain; -webkit-overflow-scrolling:touch; touch-action:pan-y;'
                                                : 'position:absolute; left:0; right:0; top:3.5rem; bottom:3.25rem; overflow-y:auto; overflow-x:hidden; overscroll-behavior:contain;'">
                                            ...
                                            <div class="p-3 bg-gray-50 border-t border-gray-200 rounded-b-lg" :style="(window.innerWidth < 640)
                                                ? 'position:absolute; left:0; right:0; bottom:0; min-height:3.25rem; padding: 0.75rem 1rem calc(0.75rem + env(safe-area-inset-bottom)); background-color: #f9fafb; border-top: 1px solid #e5e7eb; z-index:2;'
                                                : 'position:absolute; left:0; right:0; bottom:0; min-height:3.25rem; padding: 0.75rem 1rem; background-color: #f9fafb; border-top: 1px solid #e5e7eb; z-index:2;'">
