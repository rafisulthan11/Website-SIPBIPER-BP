<x-app-layout>
        ...
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-blue-600 text-white rounded-t-xl shadow-lg">
                <div class="flex justify-center items-center gap-1 p-2">
                    <!-- Tab Aktif: Background putih dengan teks biru -->
                    <a href="{{ route('peta-lokasi.index') }}" class="px-8 py-3 font-bold bg-white text-blue-700 rounded-lg shadow-md whitespace-nowrap">
                        Peta Interaktif Pembudidaya
                    </a>
                    <!-- Tab Tidak Aktif: Background transparan dengan teks putih -->
            ...
            <div class="bg-white rounded-b-xl shadow-lg p-6">
                <!-- Filter Section -->
                <div class="mb-4">
                    <h2 class="text-lg font-semibold mb-3">Peta Lokasi Pembudidaya</h2>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Data pembudidaya
        let pembudidayaData = @json($pembudidayas ?? []);
        ...
        function applyFilters() {
            ...
            if (jenisFilter) {
                filteredData = filteredData.filter(p => 
                    p.jenis_budidaya && p.jenis_budidaya.toLowerCase().includes(jenisFilter.toLowerCase())
                );
            }
