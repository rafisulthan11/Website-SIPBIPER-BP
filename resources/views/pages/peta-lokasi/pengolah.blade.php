<x-app-layout>
            ...
            <div class="bg-white rounded-b-xl shadow-lg p-6">
                ...
                <div class="mb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <!-- (Jenis Budidaya removed for Pengolah view) -->
                    </div>
                </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Data (coba ambil dari $pengolahs dulu, fallback ke $pembudidayas)
        let pembudidayaData = @json($pengolahs ?? $pembudidayas ?? []);
        ...
        function addMarkers(data) {
            ...
            data.forEach(item => {
                if (item.latitude && item.longitude) {
                    ...
                    const iconType = item.type || 'pengolah';
