    ...
    <div class="py-6">
        <div class="px-4 sm:px-6 lg:px-8">
            <div x-data="{ step: {{ $initialStep }}, maxStep: 7 }" class="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-200">
                ...
                <form method="POST" action="{{ route('pembudidaya.update', $pembudidaya->id_pembudidaya) }}" enctype="multipart/form-data" novalidate data-skip-multistep-validation="1">
                    @csrf
                    @method('PUT')
                    <!-- Step panels -->
                    <div class="px-6 pb-6">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <select name="tahun_pendataan" id="tahun_pendataan" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" required>
                                        ...
                                        @foreach($years as $year)
                                            <option value="{{ $year }}" {{ old('tahun_pendataan', $pembudidaya->tahun_pendataan ?? $currentYear) == $year ? 'selected' : '' }}>{{ $year }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="jenis_kegiatan_usaha" id="jenis_kegiatan_usaha" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm">
                                        ...
                                        <option value="Pembenihan/Pembibitan" {{ (old('jenis_kegiatan_usaha', $pembudidaya->jenis_kegiatan_usaha) == 'Pembenihan/Pembibitan') ? 'selected' : '' }}>Pembenihan/Pembibitan</option>
                        ...
                        <div x-show="step===1" x-transition class="bg-gray-50 rounded-lg border border-gray-200 p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="nik_pembudidaya" class="block mt-1 w-full" type="text" name="nik_pembudidaya" :value="old('nik_pembudidaya', $pembudidaya->nik_pembudidaya)" required maxlength="16" inputmode="numeric" pattern="[0-9]*" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="kontak" class="block mt-1 w-full" type="text" name="kontak" :value="old('kontak', $pembudidaya->kontak)" required />
                        ...
                        <div x-show="step===2" x-transition class="bg-gray-50 rounded-lg border border-gray-200 p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="izin_nib" class="block mt-1 w-full" type="text" name="izin[nib]" :value="old('izin.nib', optional($iz)->nib)" />
                                </div>
                                <div>
                                    <x-input-label for="izin_npwp" value="NPWP" />
                                    <x-text-input id="izin_npwp" class="block mt-1 w-full" type="text" name="izin[npwp]" :value="old('izin.npwp', optional($iz)->npwp)" />
                                </div>
                                <div>
                                    <x-input-label for="izin_kusuka" value="KUSUKA" />
                                    <x-text-input id="izin_kusuka" class="block mt-1 w-full" type="text" name="izin[kusuka]" :value="old('izin.kusuka', optional($iz)->kusuka)" />
                                </div>
                                
                                <!-- Baris 2 -->
                                <div>
                                    <x-input-label for="izin_pengesahan_menkumham" value="Pengesahan MENKUMHAM" />
                                    <x-text-input id="izin_pengesahan_menkumham" class="block mt-1 w-full" type="text" name="izin[pengesahan_menkumham]" :value="old('izin.pengesahan_menkumham', optional($iz)->pengesahan_menkumham)" />
                                </div>
                                <div>
                                    <x-input-label for="izin_cbib" value="CBIB" />
                                    <x-text-input id="izin_cbib" class="block mt-1 w-full" type="text" name="izin[cbib]" :value="old('izin.cbib', optional($iz)->cbib)" />
                                </div>
                                <div>
                                    <x-input-label for="izin_skai" value="SKAI (Surat Keterangan Asal Ikan)" />
                                    <x-text-input id="izin_skai" class="block mt-1 w-full" type="text" name="izin[skai]" :value="old('izin.skai', optional($iz)->skai)" />
                                </div>
                                
                                <!-- Baris 3 -->
                                <div>
                                    <x-input-label for="izin_surat_ijin_pembudidayaan_ikan" value="Surat Ijin Pembudidayaan Ikan" />
                                    <x-text-input id="izin_surat_ijin_pembudidayaan_ikan" class="block mt-1 w-full" type="text" name="izin[surat_ijin_pembudidayaan_ikan]" :value="old('izin.surat_ijin_pembudidayaan_ikan', optional($iz)->surat_ijin_pembudidayaan_ikan)" />
                                </div>
                                <div>
                                    <x-input-label for="izin_akta_pendirian_usaha" value="AKTA Pendirian Usaha" />
                                    <x-text-input id="izin_akta_pendirian_usaha" class="block mt-1 w-full" type="text" name="izin[akta_pendirian_usaha]" :value="old('izin.akta_pendirian_usaha', optional($iz)->akta_pendirian_usaha)" />
                                </div>
                                <div>
                                    <x-input-label for="izin_imb" value="IMB" />
                                    <x-text-input id="izin_imb" class="block mt-1 w-full" type="text" name="izin[imb]" :value="old('izin.imb', optional($iz)->imb)" />
                                </div>
                                
                                <!-- Baris 4 -->
                                <div>
                                    <x-input-label for="izin_sup_perikanan" value="SUP Perikanan" />
                                    <x-text-input id="izin_sup_perikanan" class="block mt-1 w-full" type="text" name="izin[sup_perikanan]" :value="old('izin.sup_perikanan', optional($iz)->sup_perikanan)" />
                                </div>
                                <div>
                                    <x-input-label for="izin_sup_perdagangan" value="SUP Perdagangan" />
                                    <x-text-input id="izin_sup_perdagangan" class="block mt-1 w-full" type="text" name="izin[sup_perdagangan]" :value="old('izin.sup_perdagangan', optional($iz)->sup_perdagangan)" />
                                </div>
                            </div>
                        </div>
                        ...
                        @php
                            ...
                            $produksiByProduct = $pembudidaya->produksi->keyBy('product_index');
                            $kolamsByProduct = $pembudidaya->kolam->groupBy('product_index');
                            $ikansByProduct = $pembudidaya->ikan->groupBy('product_index');
                            $productIndexes = $produksiByProduct->keys()->merge($kolamsByProduct->keys())->merge($ikansByProduct->keys())->unique()->sort()->values();
                            
                            // Prepare products array with actual product_index
                            $productsData = [];
                            $kolamsData = [];
                            $ikansData = [];
                            
                            if ($productIndexes->count() > 0) {
                                foreach ($productIndexes as $idx) {
                                    $productsData[] = ['productIndex' => $idx];
                                    $kolamsData[] = $kolamsByProduct->get($idx, collect())->map(fn($k) => ['id' => $k->id_kolam, 'jenis' => $k->jenis_kolam, 'ukuran' => $k->ukuran, 'jumlah' => $k->jumlah, 'komoditas' => $k->komoditas])->toArray();
                                    $ikansData[] = $ikansByProduct->get($idx, collect())->map(fn($i) => ['id' => $i->id_ikan, 'jenis' => $i->jenis_ikan, 'jenis_indukan' => $i->jenis_indukan, 'jumlah' => $i->jumlah, 'asal' => $i->asal])->toArray();
                                }
                            } else {
                                $productsData = [['productIndex' => 0]];
                                $kolamsData = [[]];
                                $ikansData = [[]];
                            }
                        @endphp
                        <div x-show="step===5" x-transition class="bg-gray-50 rounded-lg border border-gray-200 p-6" x-data="{ 
                            ...
                            kolams: {{ json_encode($kolamsData) }}, 
                            ikans: {{ json_encode($ikansData) }},
                            totalLuasKolam: {{ json_encode($produksiByProduct->map(fn($p) => floatval($p->total_luas_kolam ?? 0))->toArray()) }},
                            getNextProductIndex() {
                                let maxIndex = 0;
                                        ...
                                        <div class="bg-white rounded-lg p-4 border border-gray-300">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                                <div>
                                                    ...
                                                    @php $bulanByIndex = $produksiByProduct->map(fn($p) => $p->bulan ?? '')->toArray(); @endphp
                                                    <select x-bind:name="'produksi['+product.productIndex+'][bulan]'" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm">
                                                        ...
                                                        @foreach(['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus', 'September', 'Oktober', 'November', 'Desember'] as $bulan)
                                                            <option value="{{ $bulan }}" x-bind:selected="{{ json_encode($bulanByIndex) }}[pIndex] === '{{ $bulan }}'">{{ $bulan }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div>
                                                ...
                                                <div>
                                                    ...
                                                    <input class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" type="number" step="0.01" x-bind:name="'produksi['+product.productIndex+'][total_produksi]'" x-bind:value="{{ json_encode($produksiByProduct->map(fn($p) => $p->total_produksi ?? '0.00')->toArray()) }}[pIndex] || '0.00'" placeholder="0.00" />
                                                </div>
                                                <div>
                                                    <x-input-label :value="__('Satuan Produksi')" />
                                                    @php $satuanByIndex = $produksiByProduct->map(fn($p) => $p->satuan_produksi ?? '')->toArray(); @endphp
                                                    <select x-bind:name="'produksi['+product.productIndex+'][satuan_produksi]'" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm">
                                                        ...
                                                        @foreach(['Kg', 'Ton', 'Ekor'] as $satuan)
                                                            <option value="{{ $satuan }}" x-bind:selected="{{ json_encode($satuanByIndex) }}[pIndex] === '{{ $satuan }}'">{{ $satuan }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div>
                                                    <x-input-label :value="__('Harga per Satuan')" />
                                                    <input class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" type="number" step="0.01" x-bind:name="'produksi['+product.productIndex+'][harga_per_satuan]'" x-bind:value="{{ json_encode($produksiByProduct->map(fn($p) => $p->harga_per_satuan ?? '0.00')->toArray()) }}[pIndex] || '0.00'" placeholder="0.00" />
                                                </div>
                                            </div>
                                        </div>
