        ...
        <div class="px-4 sm:px-6 lg:px-8">
            <div class="rounded-lg overflow-hidden shadow-md">
                ...
                <div class="bg-blue-600 text-white px-6 py-4">
                    <h3 class="text-2xl font-bold">Data Pemasar</h3>
                </div>
                ...
                <div class="bg-white border-x border-b border-slate-200">
                    ...
                    <div class="p-5">
                        <!-- Title -->
                        <div class="mb-4">
                            <h4 class="text-slate-800 font-semibold text-lg">Daftar Pemasar</h4>
                        </div>
                            ...
                            <!-- Right side: Filters and Add button -->
                                ...
                                <div class="flex items-center gap-2" style="display: flex; align-items: center; gap: 0.5rem;">
                                    <label class="text-sm font-medium text-slate-700 whitespace-nowrap">Search:</label>
                                        ...
                                        <input type="text" name="search" value="{{ $search ?? '' }}" placeholder="Cari data..." class="border border-gray-300 rounded-md pl-10 pr-4 py-1.5 text-sm placeholder:text-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm hover:border-gray-400 transition w-full sm:w-64" style="width: 100%;" />
                ...
                <div class="px-5 pb-5">
                    ...
                    <!-- Pagination -->
                    <div class="mt-4">
                        {{ $pemasars->onEachSide(1)->links('components.pagination.custom') }}
                    </div>
                </div>
            </div>
            </div>
