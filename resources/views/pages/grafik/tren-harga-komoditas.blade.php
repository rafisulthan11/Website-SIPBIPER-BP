<x-app-layout>
    <x-slot name="header">
        <h2 class="font-extrabold text-2xl sm:text-3xl text-slate-800 leading-tight">Grafik Tren Harga Komoditas</h2>
    </x-slot>
    ...
    <div class="py-6">
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            {{-- Tahun filter will be shown below the page title inside the chart card --}}

            <div class="max-w-7xl mx-auto bg-slate-50 rounded shadow-lg p-8 mt-0">
                <h3 class="text-3xl font-extrabold text-center mb-6">Grafik Tren Harga Komoditas</h3>
                {{-- filter tahun positioned below the title, right aligned inside the card --}}
                <div class="mb-4">
                    <div class="flex justify-end">
                        ...
                        @endphp
                        <form method="GET" action="{{ route('grafik.tren.harga.komoditas') }}" class="flex items-center gap-3">
                            <div class="relative">
                ...
                <div class="bg-white p-6 rounded shadow">
                    <canvas id="chartTren" width="800" height="400"></canvas>
                </div>
            </div>
        </div>
    </div>
