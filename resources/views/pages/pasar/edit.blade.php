                ...
                <div class="p-5 sm:p-6">
                    <form action="{{ route('pasar.update', $pasar->id_pasar) }}" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="kode_pasar" name="kode_pasar" value="{{ old('kode_pasar', $pasar->kode_pasar) }}" required class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Masukkan kode pasar">
                            @error('kode_pasar')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
