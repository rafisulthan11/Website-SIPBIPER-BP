                ...
                <div class="p-5 sm:p-6">
                    <form action="{{ route('pasar.update', $pasar->id_pasar) }}" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="kecamatan" name="kecamatan" value="{{ old('kecamatan', $pasar->kecamatan) }}" required class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Masukkan kecamatan">
                            @error('kecamatan')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="desa" name="desa" value="{{ old('desa', $pasar->desa) }}" required class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Masukkan desa">
                            @error('desa')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
