                                ...
                                <div class="rounded-lg border border-slate-200 p-4 bg-white shadow-sm">
                                    ...
                                    <div class="mt-3 flex flex-wrap gap-2">
                                        @if($user->isSuperAdmin())
                                            <span class="inline-block rounded bg-slate-100 px-3 py-1.5 text-xs font-medium text-slate-600">Terkunci</span>
                                        @else
                                    ...
                                    <tr class="border-t border-slate-200">
                                        ...
                                        <td class="px-4 py-3 align-top">
                                            <div class="flex items-center gap-2">
                                                @if($user->isSuperAdmin())
                                                    <span class="inline-block rounded bg-slate-100 px-2 py-2 text-xs font-medium text-slate-600">Terkunci</span>
                                                @else
