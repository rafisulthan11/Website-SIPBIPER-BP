        ...
        <div class="px-4 sm:px-6 lg:px-8">
            <div class="rounded-lg overflow-hidden shadow-md">
                ...
                <div class="bg-white border-x border-b border-slate-200">
                    ...
                    <form method="GET" action="{{ route('pengolah.index') }}" class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="{{ route('pengolah.create') }}" class="inline-flex items-center justify-center bg-blue-700 hover:bg-blue-800 text-white font-medium text-sm rounded-lg px-4 py-1.5 shadow whitespace-nowrap">
                    ...
                    <div class="rounded-md border border-slate-300 overflow-hidden">
                        <table class="min-w-full text-base">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="6" class="px-4 py-6 text-center text-slate-500">Belum ada data pengolah.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
