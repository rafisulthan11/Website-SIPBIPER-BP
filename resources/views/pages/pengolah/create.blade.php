    ...
    <div class="py-6">
        <div class="px-4 sm:px-6 lg:px-8">
            <div x-data="{ step: {{ $initialStep }}, maxStep: 6, products: [{}], materials: [[{}]] }" class="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-200">
                ...
                <form method="POST" action="{{ route('pengolah.store') }}" enctype="multipart/form-data" novalidate data-skip-multistep-validation="1">
                    @csrf
                    <!-- Step panels -->
                    <div class="px-6 pb-6">
                        <!-- Step 0: Jenis Usaha -->
                        ...
                        <div x-show="step===1" x-transition class="bg-gray-50 rounded-lg border border-gray-200 p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="nik_pengolah" class="block mt-1 w-full" type="text" name="nik_pengolah" :value="old('nik_pengolah')" required maxlength="16" inputmode="numeric" pattern="[0-9]*" />
                                        ...
                                        <div class="bg-white p-4 rounded-lg border border-gray-200">
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                ...
                                                <div>
                                                    ...
                                                    <select class="block mt-2 w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm" x-bind:name="'produksi['+index+'][komoditas]'">
