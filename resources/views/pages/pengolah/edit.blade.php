<x-app-layout>
    ...
    <div class="py-6">
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            }" x-init="console.log('Alpine initialized. Step:', step, 'MaxStep:', maxStep)" class="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-200">
                <!-- Header -->
                                ...
                                <div>
                                    ...
                                    <select name="tahun_pendataan" id="tahun_pendataan" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" required>
                                        ...
                                        @foreach($years as $year)
                                            <option value="{{ $year }}" {{ old('tahun_pendataan', $pengolah->tahun_pendataan ?? $currentYear) == $year ? 'selected' : '' }}>{{ $year }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div x-show="step===2" x-transition class="bg-gray-50 rounded-lg border border-gray-200 p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="nib" class="block mt-1 w-full" type="text" name="nib" :value="old('nib', $pengolah->nib)" />
                                </div>
                                <div>
                                    <x-input-label for="npwp_usaha" :value="__('NPWP')" />
                                    <x-text-input id="npwp_usaha" class="block mt-1 w-full" type="text" name="npwp_usaha" :value="old('npwp_usaha', $pengolah->npwp_usaha)" />
                                </div>
                                <div>
                                    <x-input-label for="kusuka" :value="__('KUSUKA')" />
                                    <x-text-input id="kusuka" class="block mt-1 w-full" type="text" name="kusuka" :value="old('kusuka', $pengolah->kusuka)" />
                                </div>
                                <div>
                                    <x-input-label for="pengesahan_menkumham" :value="__('Pengesahan MENKUMHAM')" />
                                    <x-text-input id="pengesahan_menkumham" class="block mt-1 w-full" type="text" name="pengesahan_menkumham" :value="old('pengesahan_menkumham', $pengolah->pengesahan_menkumham)" />
                                </div>
                                <div>
                                    <x-input-label for="tdu_php" :value="__('TDU-PHP')" />
                                    <x-text-input id="tdu_php" class="block mt-1 w-full" type="text" name="tdu_php" :value="old('tdu_php', $pengolah->tdu_php)" />
                                </div>
                                <div>
                                    <x-input-label for="akta_pendirian_usaha" :value="__('AKTA Pendirian Usaha')" />
                                    <x-text-input id="akta_pendirian_usaha" class="block mt-1 w-full" type="text" name="akta_pendirian_usaha" :value="old('akta_pendirian_usaha', $pengolah->akta_pendirian_usaha)" />
                                </div>
                                <div>
                                    <x-input-label for="imb" :value="__('IMB')" />
                                    <x-text-input id="imb" class="block mt-1 w-full" type="text" name="imb" :value="old('imb', $pengolah->imb)" />
                                </div>
                                <div>
                                    <x-input-label for="siup_perikanan" :value="__('SIUP Perikanan')" />
                                    <x-text-input id="siup_perikanan" class="block mt-1 w-full" type="text" name="siup_perikanan" :value="old('siup_perikanan', $pengolah->siup_perikanan)" />
                                </div>
                                <div>
                                    <x-input-label for="siup_perdagangan" :value="__('SIUP Perdagangan')" />
                                    <x-text-input id="siup_perdagangan" class="block mt-1 w-full" type="text" name="siup_perdagangan" :value="old('siup_perdagangan', $pengolah->siup_perdagangan)" />
                                </div>
                                <div>
                                    <x-input-label for="sppl" :value="__('SPPL')" />
                                    <x-text-input id="sppl" class="block mt-1 w-full" type="text" name="sppl" :value="old('sppl', $pengolah->sppl)" />
                                </div>
                                <div>
                                    <x-input-label for="ukl_upl" :value="__('UKL-UPL')" />
                                    <x-text-input id="ukl_upl" class="block mt-1 w-full" type="text" name="ukl_upl" :value="old('ukl_upl', $pengolah->ukl_upl)" />
                                </div>
                                <div>
                                    <x-input-label for="amdal" :value="__('AMDAL')" />
                                    <x-text-input id="amdal" class="block mt-1 w-full" type="text" name="amdal" :value="old('amdal', $pengolah->amdal)" />
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="bg-white p-4 rounded-lg border border-gray-200">
                                            ...
                                            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
                                                <label class="flex items-center p-2 border border-gray-200 rounded hover:bg-gray-50 cursor-pointer">
                                                    <input type="checkbox" x-bind:name="'produksi['+index+'][bulan_produksi][]'" value="Januari" x-bind:checked="product.bulan_produksi && product.bulan_produksi.includes('Januari')" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                                    <span class="ml-2 text-sm">Januari</span>
                                                </label>
                                                <label class="flex items-center p-2 border border-gray-200 rounded hover:bg-gray-50 cursor-pointer">
                                                    <input type="checkbox" x-bind:name="'produksi['+index+'][bulan_produksi][]'" value="Februari" x-bind:checked="product.bulan_produksi && product.bulan_produksi.includes('Februari')" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                                    <span class="ml-2 text-sm">Februari</span>
                                                </label>
                                                <label class="flex items-center p-2 border border-gray-200 rounded hover:bg-gray-50 cursor-pointer">
                                                    <input type="checkbox" x-bind:name="'produksi['+index+'][bulan_produksi][]'" value="Maret" x-bind:checked="product.bulan_produksi && product.bulan_produksi.includes('Maret')" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                                    <span class="ml-2 text-sm">Maret</span>
                                                </label>
                                                <label class="flex items-center p-2 border border-gray-200 rounded hover:bg-gray-50 cursor-pointer">
                                                    <input type="checkbox" x-bind:name="'produksi['+index+'][bulan_produksi][]'" value="April" x-bind:checked="product.bulan_produksi && product.bulan_produksi.includes('April')" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                                    <span class="ml-2 text-sm">April</span>
                                                </label>
                                                <label class="flex items-center p-2 border border-gray-200 rounded hover:bg-gray-50 cursor-pointer">
                                                    <input type="checkbox" x-bind:name="'produksi['+index+'][bulan_produksi][]'" value="Mei" x-bind:checked="product.bulan_produksi && product.bulan_produksi.includes('Mei')" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                                    <span class="ml-2 text-sm">Mei</span>
                                                </label>
                                                <label class="flex items-center p-2 border border-gray-200 rounded hover:bg-gray-50 cursor-pointer">
                                                    <input type="checkbox" x-bind:name="'produksi['+index+'][bulan_produksi][]'" value="Juni" x-bind:checked="product.bulan_produksi && product.bulan_produksi.includes('Juni')" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                                    <span class="ml-2 text-sm">Juni</span>
                                                </label>
                                                <label class="flex items-center p-2 border border-gray-200 rounded hover:bg-gray-50 cursor-pointer">
                                                    <input type="checkbox" x-bind:name="'produksi['+index+'][bulan_produksi][]'" value="Juli" x-bind:checked="product.bulan_produksi && product.bulan_produksi.includes('Juli')" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                                    <span class="ml-2 text-sm">Juli</span>
                                                </label>
                                                <label class="flex items-center p-2 border border-gray-200 rounded hover:bg-gray-50 cursor-pointer">
                                                    <input type="checkbox" x-bind:name="'produksi['+index+'][bulan_produksi][]'" value="Agustus" x-bind:checked="product.bulan_produksi && product.bulan_produksi.includes('Agustus')" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                                    <span class="ml-2 text-sm">Agustus</span>
                                                </label>
                                                <label class="flex items-center p-2 border border-gray-200 rounded hover:bg-gray-50 cursor-pointer">
                                                    <input type="checkbox" x-bind:name="'produksi['+index+'][bulan_produksi][]'" value="September" x-bind:checked="product.bulan_produksi && product.bulan_produksi.includes('September')" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                                    <span class="ml-2 text-sm">September</span>
                                                </label>
                                                <label class="flex items-center p-2 border border-gray-200 rounded hover:bg-gray-50 cursor-pointer">
                                                    <input type="checkbox" x-bind:name="'produksi['+index+'][bulan_produksi][]'" value="Oktober" x-bind:checked="product.bulan_produksi && product.bulan_produksi.includes('Oktober')" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                                    <span class="ml-2 text-sm">Oktober</span>
                                                </label>
                                                <label class="flex items-center p-2 border border-gray-200 rounded hover:bg-gray-50 cursor-pointer">
                                                    <input type="checkbox" x-bind:name="'produksi['+index+'][bulan_produksi][]'" value="November" x-bind:checked="product.bulan_produksi && product.bulan_produksi.includes('November')" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                                    <span class="ml-2 text-sm">November</span>
                                                </label>
                                                <label class="flex items-center p-2 border border-gray-200 rounded hover:bg-gray-50 cursor-pointer">
                                                    <input type="checkbox" x-bind:name="'produksi['+index+'][bulan_produksi][]'" value="Desember" x-bind:checked="product.bulan_produksi && product.bulan_produksi.includes('Desember')" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
