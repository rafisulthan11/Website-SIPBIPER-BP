                ...
                <div class="p-5 sm:p-6">
                    <form action="{{ route('komoditas.store') }}" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="nama_komoditas" name="nama_komoditas" value="{{ old('nama_komoditas') }}" required class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Masukkan nama komoditas">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="kode" name="kode" value="{{ old('kode') }}" required class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Masukkan kode komoditas">
                            @error('kode')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
