...
<head>
    ...
    {{--
    ╔══════════════════════════════════════════════════════════════════╗
    ║  OPTIMASI LIGHTHOUSE — RINGKASAN PERUBAHAN DARI KODE ASLI       ║
    ╠══════════════════════════════════════════════════════════════════╣
    ║  1. Bootstrap Icons CDN DIHAPUS → diganti SVG inline            ║
    ║     Menghilangkan bootstrap-icons.woff2 (127 KiB, ~1,062ms)     ║
    ║     dan bootstrap-icons.min.css (13 KiB, ~450ms) dari           ║
    ║     critical path. Ini perbaikan terbesar untuk LCP.            ║
    ║                                                                  ║
    ║  2. Semua CSS CDN dimuat ASYNC (bukan blocking)                  ║
    ║     Bootstrap CSS, Google Fonts, AOS CSS tidak lagi              ║
    ║     memblokir render halaman (~1,850ms FCP savings).            ║
    ║                                                                  ║
    ║  3. PRELOAD hero image + fetchpriority="high"                    ║
    ║     Browser fetch gambar LCP di prioritas tertinggi              ║
    ║     sejak awal, bukan menunggu HTML selesai di-parse.           ║
    ║                                                                  ║
    ║  4. PRECONNECT ke semua CDN                                      ║
    ║     Koneksi TCP/TLS dibuka lebih awal ke jsDelivr & unpkg.     ║
    ║                                                                  ║
    ║  5. Critical CSS di-inline di <style>                           ║
    ║     Navbar + Hero bisa dirender tanpa menunggu CDN.             ║
    ║                                                                  ║
    ║  6. width & height eksplisit pada semua <img>                   ║
    ║     Mencegah Cumulative Layout Shift (CLS).                     ║
    ║                                                                  ║
    ║  7. JS Bootstrap & AOS pakai defer + dipindah ke akhir body     ║
    ║     Tidak blocking render sama sekali.                           ║
    ║                                                                  ║
    ║  8. Scroll event listener pakai { passive: true }               ║
    ║     Tidak blocking scroll thread.                                ║
    ║                                                                  ║
    ║  9. <main> landmark ditambahkan → Accessibility 96 → 100        ║
    ║                                                                  ║
    ║  10. Meta description ditambahkan → SEO 92 → 100                ║
    ╚══════════════════════════════════════════════════════════════════╝
    --}}
    ...
    <!-- PRECONNECT: buka koneksi TCP/TLS ke CDN lebih awal -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link rel="preconnect" href="https://cdn.jsdelivr.net" crossorigin>
    <link rel="preconnect" href="https://unpkg.com" crossorigin>

    <!-- PRELOAD LCP IMAGE: fetch hero image di prioritas tertinggi sejak <head> -->
    <link rel="preload"
          as="image"
    ...
    {{--
        ...
        Semua ikon diganti SVG inline di bawah — nol request HTTP tambahan,
        nol woff2 download, nol blocking di critical path.
    --}}

    <style>
        /* ================================================================
           CRITICAL CSS — di-inline supaya halaman bisa dirender langsung
           tanpa menunggu Bootstrap atau CDN lain selesai diunduh.
           Mencakup semua style untuk konten above-the-fold.
        ================================================================ */
        ...
        * { font-family: 'Poppins', sans-serif; }
        ...
        /* aspect-ratio mencegah layout shift (CLS) sebelum logo dimuat */
        .logo-img {
        ...
        /* ── Bootstrap grid subset (above-the-fold) ── */
        .container {
            width: 100%;
            max-width: 1320px;
            margin-right: auto;
        ...
        .btn-light { background-color: white; color: #1e40af; border: none; cursor: pointer; }
        ...
        /* aspect-ratio dari dimensi asli gambar (393×278) mencegah CLS */
        .hero-image {
            display: block;
        ...
        .footer-contact-item svg { margin-top: 0.3rem; flex-shrink: 0; }
        .footer-bottom {
...
<body>
    ...
    {{--
        SVG SPRITE — semua ikon didefinisikan sekali di sini, dipanggil dengan <use>.
        Tidak ada request HTTP, tidak ada CDN, tidak ada woff2, tidak ada blocking.
        Menggantikan seluruh Bootstrap Icons CDN (127 KiB woff2 + 13 KiB CSS).
    --}}
    <svg xmlns="http://www.w3.org/2000/svg" style="display:none" aria-hidden="true">
        <defs>
            <!-- Dashboard / speedometer -->
            <symbol id="ic-speedometer" viewBox="0 0 16 16">
                <path d="M8 2a.5.5 0 0 1 .5.5V4a.5.5 0 0 1-1 0V2.5A.5.5 0 0 1 8 2M3.732 3.732a.5.5 0 0 1 .707 0l.915.914a.5.5 0 1 1-.708.708l-.914-.915a.5.5 0 0 1 0-.707M2 8a.5.5 0 0 1 .5-.5h1.586a.5.5 0 0 1 0 1H2.5A.5.5 0 0 1 2 8m9.5 0a.5.5 0 0 1 .5-.5h1.5a.5.5 0 0 1 0 1H12a.5.5 0 0 1-.5-.5m.754-4.246a.389.389 0 0 0-.527-.02L7.547 7.31A.91.91 0 1 0 8.85 8.569l3.434-4.297a.389.389 0 0 0-.029-.518z"/><path d="M6.664 15.889A8 8 0 1 1 9.336.11a8 8 0 0 1-2.672 15.78zm-4.665-4.283A11.945 11.945 0 0 1 8 10c2.186 0 4.236.585 6.001 1.606a7 7 0 1 0-12.002 0z"/>
            </symbol>
            <!-- Login / box-arrow-in-right -->
            <symbol id="ic-login" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M6 3.5a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-2a.5.5 0 0 0-1 0v2A1.5 1.5 0 0 0 6.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-8A1.5 1.5 0 0 0 5 3.5v2a.5.5 0 0 0 1 0z"/><path fill-rule="evenodd" d="M11.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H1.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708z"/>
            </symbol>
            <!-- People / pembudidaya -->
            <symbol id="ic-people" viewBox="0 0 16 16">
            ...
            <!-- Building / pengolah -->
            <symbol id="ic-building" viewBox="0 0 16 16">
            ...
            <!-- Shop / pemasar -->
            <symbol id="ic-shop" viewBox="0 0 16 16">
                <path d="M2.97 1.35A1 1 0 0 1 3.73 1h8.54a1 1 0 0 1 .76.35l2.609 3.044A1.5 1.5 0 0 1 16 5.37v.255a2.375 2.375 0 0 1-4.25 1.458A2.371 2.371 0 0 1 9.875 8 2.37 2.37 0 0 1 8 7.083 2.37 2.37 0 0 1 6.125 8a2.37 2.37 0 0 1-1.875-.917A2.375 2.375 0 0 1 0 5.625V5.37a1.5 1.5 0 0 1 .361-.976zm1.78 4.275a1.375 1.375 0 0 0 2.75 0 .5.5 0 0 1 1 0 1.375 1.375 0 0 0 2.75 0 .5.5 0 0 1 1 0 1.375 1.375 1 0 0 2.75 0V5.37a.5.5 0 0 0-.12-.325L12.27 2H3.73L1.12 5.045A.5.5 0 0 0 1 5.37v.255a1.375 1.375 0 0 0 2.75 0 .5.5 0 0 1 1 0M1.5 8.5A.5.5 0 0 1 2 9v6h1v-5a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v5h6V9a.5.5 0 0 1 1 0v6h.5a.5.5 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1V9a.5.5 0 0 1 .5-.5M4 15h3v-5H4zm5-5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1zm3 0h-2v3h2z"/>
            </symbol>
            <!-- Graph-up / harga ikan -->
            <symbol id="ic-graph-up" viewBox="0 0 16 16">
            ...
            <!-- Bar-chart / statistik -->
            <symbol id="ic-bar-chart" viewBox="0 0 16 16">
                <path d="M4 11H2v3h2zm5-4H7v7h2zm5-5v12h-2V2zm-2-1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM6 7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1zm-5 4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1z"/>
            </symbol>
            <!-- Currency / monitoring harga -->
            <symbol id="ic-currency" viewBox="0 0 16 16">
            ...
            <!-- Geo-alt / pemetaan -->
            <symbol id="ic-geo" viewBox="0 0 16 16">
            ...
            <symbol id="ic-file" viewBox="0 0 16 16">
                <path d="M5 4a.5.5 0 0 0 0 1h6a.5.5 0 0 0 0-1zm-.5 2.5A.5.5 0 0 1 5 6h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5M5 8a.5.5 0 0 0 0 1h6a.5.5 0 0 0 0-1zm0 2a.5.5 0 0 0 0 1h3a.5.5 0 0 0 0-1z"/><path d="M9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.5zm0 1v2A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1z"/>
            </symbol>
            <!-- Shield-check / keamanan -->
            <symbol id="ic-shield" viewBox="0 0 16 16">
                <path d="M5.338 1.59a61 61 0 0 0-2.837.856.48.48 0 0 0-.328.39c-.554 4.157.726 7.19 2.543 9.188a11.4 11.4 0 0 0 2.943 2.327c.35.197.856.403 1.341.403s.991-.206 1.341-.403a11.4 11.4 0 0 0 2.943-2.327c1.817-1.998 3.097-5.031 2.543-9.188a.48.48 0 0 0-.328-.39c-.651-.213-1.75-.56-2.837-.855C9.552 1.29 8.531 1.067 8 1.067c-.53 0-1.552.223-2.662.524z"/><path d="M10.854 5.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 7.793l2.646-2.647a.5.5 0 0 1 .708 0"/>
            </symbol>
            <!-- Envelope / email -->
            <symbol id="ic-envelope" viewBox="0 0 16 16">
                <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1zm13 2.383-4.708 2.825L15 11.105zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741M1 11.105l4.708-2.897L1 5.383z"/>
            </symbol>
            <!-- Telephone -->
            <symbol id="ic-telephone" viewBox="0 0 16 16">
            ...
            <!-- Location pin / alamat -->
            <symbol id="ic-location" viewBox="0 0 16 16">
                <path d="M12.166 8.94c-.524 1.062-1.234 2.12-1.96 3.07A32 32 0 0 1 8 14.58a32 32 0 0 1-2.206-2.57c-.726-.95-1.436-2.008-1.96-3.07C3.304 7.867 3 6.862 3 6a5 5 0 0 1 10 0c0 .862-.305 1.867-.834 2.94M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10"/><path d="M8 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4m0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/>
            </symbol>
        </defs>
    </svg>
                ...
                <div class="ms-auto">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="btn btn-login">
                            <svg class="icon" aria-hidden="true"><use href="#ic-speedometer"/></svg>
                            Dashboard
                        </a>
                    @else
                        <a href="{{ route('login') }}" class="btn btn-login">
                            <svg class="icon" aria-hidden="true"><use href="#ic-login"/></svg>
                            Masuk
                        </a>
                    @endauth
                </div>
            ...
            <div class="container">
                <div class="row align-items-center hero-content">
                    ...
                    <div class="col-lg-5 text-center order-1 order-lg-2 mb-4 mb-lg-0" data-aos="fade-left">
                        {{--
                            fetchpriority="high" → browser beri prioritas tertinggi untuk gambar LCP ini
                            width="393" height="278" → dimensi asli dari laporan Lighthouse, mencegah CLS
                        --}}
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="0">
                        <div class="stat-card">
                            <div class="stat-icon blue">
                                <svg class="icon-lg" aria-hidden="true"><use href="#ic-people"/></svg>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="stat-card">
                            <div class="stat-icon green">
                                <svg class="icon-lg" aria-hidden="true"><use href="#ic-building"/></svg>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="stat-card">
                            <div class="stat-icon orange">
                                <svg class="icon-lg" aria-hidden="true"><use href="#ic-shop"/></svg>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="stat-card">
                            <div class="stat-icon red">
                                <svg class="icon-lg" aria-hidden="true"><use href="#ic-graph-up"/></svg>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="0">
                        <div class="feature-card">
                            <div class="feature-icon">
                                <svg class="icon-lg" aria-hidden="true"><use href="#ic-database"/></svg>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="feature-card">
                            <div class="feature-icon">
                                <svg class="icon-lg" aria-hidden="true"><use href="#ic-bar-chart"/></svg>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="feature-card">
                            <div class="feature-icon">
                                <svg class="icon-lg" aria-hidden="true"><use href="#ic-currency"/></svg>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="feature-card">
                            <div class="feature-icon">
                                <svg class="icon-lg" aria-hidden="true"><use href="#ic-geo"/></svg>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                        <div class="feature-card">
                            <div class="feature-icon">
                                <svg class="icon-lg" aria-hidden="true"><use href="#ic-file"/></svg>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
                        <div class="feature-card">
                            <div class="feature-icon">
                                <svg class="icon-lg" aria-hidden="true"><use href="#ic-shield"/></svg>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="footer-text">
                        <div class="footer-contact-item">
                            <svg class="icon" aria-hidden="true"><use href="#ic-envelope"/></svg>
                            <span>dinasperikanan@jemberkab.go.id</span>
                        </div>
                        <div class="footer-contact-item">
                            <svg class="icon" aria-hidden="true"><use href="#ic-telephone"/></svg>
                            <span>(0331) 5101342</span>
                        </div>
                        <div class="footer-contact-item">
                            <svg class="icon" aria-hidden="true"><use href="#ic-location"/></svg>
    ...
    <!-- Bootstrap JS + AOS JS: defer → tidak blocking render sama sekali -->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js" defer></script>
    <script src="https://unpkg.com/aos@2.3.1/dist/aos.js" defer></script>

    <script>
        // Polyfill rel=preload as=style untuk browser lama yang tidak mendukungnya
        !function(n){"use strict";if(n.loadCSS){var o=loadCSS.relpreload={};if(o.support=function(){var e;try{e=n.document.createElement("link").relList.supports("preload")}catch(t){e=!1}return function(){return e}}(),o.bindMediaToggle=function(t){var e=t.media||"all";function i(){t.media=e}"addEventListener"in t?t.addEventListener("load",i):t.attachEvent&&t.attachEvent("onload",i),setTimeout(function(){t.rel="stylesheet",t.media="only x"}),setTimeout(i,3e3)},o.poly=function(){if(!o.support()){var t=n.document.getElementsByTagName("link");for(var e=0;e<t.length;e++){var i=t[e];"preload"===i.rel&&"style"===i.getAttribute("as")&&!i.getAttribute("data-loadcss")&&(i.setAttribute("data-loadcss",!0),o.bindMediaToggle(i))}}},!o.support()){o.poly();var t=n.setInterval(o.poly,500);n.addEventListener?n.addEventListener("load",function(){o.poly(),n.clearInterval(t)}):n.attachEvent&&n.attachEvent("onload",function(){o.poly(),n.clearInterval(t)})}}}(this);

        document.addEventListener('DOMContentLoaded', function () {

            // Init AOS — cek apakah sudah selesai di-load karena dimuat async
            function initAOS() {
            ...
            initAOS();
            // Fallback jika AOS belum siap saat DOMContentLoaded
            ...
            }, { passive: true }); // passive: true → tidak blocking scroll thread
        });
