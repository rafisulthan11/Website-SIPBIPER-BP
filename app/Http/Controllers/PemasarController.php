...
class PemasarController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'foto_npwp' => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:1024',
            'foto_izin_usaha' => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:1024',
            'foto_produk' => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:1024',
            'foto_sertifikat_pirt' => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:1024',
            'foto_sertifikat_halal' => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:1024',
        ], [
